    ...
    <div class="container">
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="#" class="pull-left">
                        <img alt="image" src="{{ url('public/assets/img/landing/avatar3.jpg') }}">
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="#" class="pull-left">
                        <img alt="image" src="{{ url('public/assets/img/landing/avatar1.jpg') }}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="#" class="pull-left">
                        <img alt="image" src="{{ url('public/assets/img/landing/avatar2.jpg') }}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
